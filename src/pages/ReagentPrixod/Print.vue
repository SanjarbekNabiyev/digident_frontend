<template>
    <div class="content">
        ...
        <div class="section-title">{{ $t('get_product') }}</div>

        <div v-for="(item, index) in datas.reagent_prixod_tables" :key="index" class="item">
            <div class="label">
...
const datas = JSON.parse(localStorage.getItem('reagentPrixod'));
const list = ref(null);
