<template>
    ...
    <n-modal v-model:show="addedModal" class="custom-card" preset="card" :style="{ width: '1000px' }"
        :title="texnikId ? t('update') : t('add_btn')">
...
import TexnikCreate from '../Texnik/Create.vue'
